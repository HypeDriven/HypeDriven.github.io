...
export default {
    ...
    data: function () {
        return {
            ...
            runningLineContent: [
                'teamPage.runningline.ceo',
                'teamPage.runningline.managers',
                'teamPage.runningline.backend',
                'teamPage.runningline.qa',
                'teamPage.runningline.frontend',
                'teamPage.runningline.designer'
            ]
        };
    },
}
